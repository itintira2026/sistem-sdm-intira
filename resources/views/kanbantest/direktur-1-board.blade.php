...
<head>
    ...
    <title>Direktur — Board Saya</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div style="padding:28px 32px;max-width:1100px;margin:0 auto;position:relative;min-height:80vh;">
        ...
        <p style="margin:0;color:#6B7280;font-size:13px;">Login sebagai: Direktur Bisnis <span style="color:#9AA1A9;">(1
                desain dipakai juga untuk Direktur Utama & Direktur Operasional)</span></p>
        ...
        <div style="display:flex;gap:14px;flex-wrap:wrap;margin-bottom:16px;font-size:11.5px;color:#6B7280;">
            ...
            <span style="display:inline-flex;align-items:center;gap:5px;"><i
                ...
                (pendukung)</span>
            <span style="display:inline-flex;align-items:center;gap:5px;"><i
                    style="width:10px;height:10px;border-radius:3px;background:#5B3FA6;display:inline-block;"></i>Kerjaan
                Sendiri</span>
        </div>
        ...
        <div id="tabAtasan" style="display:block;">
            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:14px;align-items:start;">
                ...
                <div style="background:#EEF1F0;border-radius:10px;padding:12px;min-height:200px;">
                    ...
                    <div
                        style="background:#fff;border-radius:9px;padding:12px 13px;margin-bottom:10px;cursor:pointer;border-left:3px solid #C98A3D;box-shadow:0 1px 2px rgba(20,30,25,0.05);">
                        ...
                        <div style="font-weight:600;font-size:13.5px;margin-bottom:6px;">Pertumbuhan Anggota Q3 (porsi
                            Bisnis)</div>
                        <div
                            style="display:flex;justify-content:space-between;font-size:11.5px;color:#6B7280;margin-top:8px;">
                            <span>Dari: Ketua</span><span>120/hari</span>
                        </div>
                    ...
                    <div
                        style="background:#fff;border-radius:9px;padding:12px 13px;cursor:pointer;border-left:3px solid #1B4D3E;box-shadow:0 1px 2px rgba(20,30,25,0.05);">
                        <div style="font-weight:600;font-size:13.5px;margin-bottom:6px;">Restrukturisasi Divisi
                            Operasional</div>
                        <div
                            style="display:flex;justify-content:space-between;font-size:11.5px;color:#6B7280;margin-top:8px;">
                            <span>Dari: Ketua</span><span>Belum di-breakdown</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="background:#EEF1F0;border-radius:10px;padding:12px;min-height:200px;">
                    ...
                    <div
                        style="background:#fff;border-radius:9px;padding:12px 13px;cursor:pointer;border-left:3px solid #B5502F;box-shadow:0 1px 2px rgba(20,30,25,0.05);">
                        <div style="display:flex;gap:5px;margin-bottom:6px;">
                            <span
                            ...
                            <span
                                style="display:inline-block;padding:2px 8px;border-radius:12px;font-size:11px;font-weight:600;background:#EDE8FA;color:#5B3FA6;">Kerjaan
                                Sendiri</span>
                        </div>
                        <div style="font-weight:600;font-size:13.5px;margin-bottom:6px;">Follow up 5 partner
                            strategis/minggu</div>
                        <div
                            style="display:flex;justify-content:space-between;font-size:11.5px;color:#6B7280;margin-top:8px;">
                            <span>Diri Sendiri</span><span>3/5 minggu ini</span>
                        </div>
                    </div>
                </div>
            ...
            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:14px;align-items:start;">
                <div style="background:#EEF1F0;border-radius:10px;padding:12px;min-height:160px;">
                    ...
                    <div
                        ...
                        <div style="font-weight:600;font-size:13.5px;margin-bottom:6px;">Diskusi partnership vendor baru
                        </div>
                        <div
                            style="display:flex;justify-content:space-between;font-size:11.5px;color:#6B7280;margin-top:8px;">
                            <span>Personal</span><span>3 Sep</span>
                        </div>
                    </div>
                </div>
                <div style="background:#EEF1F0;border-radius:10px;padding:12px;min-height:160px;">
