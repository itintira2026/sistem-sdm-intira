<x-app-layout>
    ...
    <script>
        ...
        //             fileError.textContent = 'Format file harus Excel (.xlsx / .xls)';
        ...
        //                 } else {
        //                     handleImportError(response.message || 'Terjadi kesalahan saat import');
        //                 }
        //             } catch {
        //                 handleImportError('Response server tidak valid');
        //             }
        //         };

        //         xhr.onerror = () => handleImportError('Kesalahan jaringan');
        //         xhr.onabort = () => handleImportError('Import dibatalkan');
        ...
        //             behavior: 'smooth'
        //         });
        //         setTimeout(() => showNotification('error', message), 300);
        //     }
    ...
    //         import-notification fixed top-4 right-4 px-6 py-3 rounded-lg shadow-lg
