...
<head>
    ...
    <title>AM — List Goal Diterima</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div style="padding:28px 32px;max-width:1100px;margin:0 auto;">
        ...
        <div style="margin-bottom:14px;">
            <h2 style="margin:0 0 4px 0;font-size:17px;">Goal Branch Saya</h2>
            <p style="margin:0;color:#6B7280;font-size:13px;">Cabang Kemang</p>
        </div>

        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:14px;">
            <a href="am-4-drilldown" style="text-decoration:none;color:inherit;">
                <div
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px;">
                        ...
                        <span
                            style="padding:2px 8px;border-radius:5px;font-size:11px;font-weight:600;background:#E4F4EB;color:#2F9E68;">87%</span>
                    </div>
                    <h3 style="font-size:14.5px;margin:0 0 4px 0;">Rekrut Anggota Baru (porsi Cabang Kemang)</h3>
                    <div style="font-size:11.5px;color:#6B7280;">15/hari · dipecah ke 3 FO</div>
                    <div style="display:flex;align-items:center;gap:8px;margin-top:12px;">
                        ...
                        <span
                            style="font-size:12px;font-weight:700;color:#C98A3D;width:36px;text-align:right;">87%</span>
                    </div>
                </div>
            </a>
        </div>
