...
<head>
    ...
    <title>Korea — Form Breakdown ke AM</title>
    <style>
        body {
            margin: 0;
    ...
    <div style="padding:28px 32px;max-width:1100px;margin:0 auto;">
        ...
        <div
            ...
            <div
                ...
                Goal induk: <strong>Rekrut Anggota Baru (porsi Area Jaksel)</strong> — sisa alokasi kuantitatif: 30/hari
            </div>

            <!-- Shortcut khas Korea/AM -->
            <div style="margin-bottom:16px;">
                ...
                <p style="font-size:11.5px;color:#6B7280;margin:8px 0 0 0;">
                    "Assign ke Semua AM" otomatis generate 1 baris per AM di semua branch yang kamu naungi (Kemang, Blok
                    M, Fatmawati). Porsi tetap bisa diedit manual setelah ter-generate.
                </p>
            </div>
            ...
            <div
                ...
                <select style="padding:7px 9px;font-size:12px;border:1px solid #E2E5E9;border-radius:6px;">
                    ...
                    <option selected>AM — Kemang</option>
                    <option>AM — Blok M</option>
                    <option>AM — Fatmawati</option>
                </select>
            ...
            <div
                ...
                <select style="padding:7px 9px;font-size:12px;border:1px solid #E2E5E9;border-radius:6px;">
                    <option>Diri Sendiri</option>
                    <option>AM — Kemang</option>
                    <option selected>AM — Blok M</option>
                    <option>AM — Fatmawati</option>
                </select>
                <input type="text" value="Rekrut Anggota Baru"
                    style="padding:7px 9px;font-size:12px;border:1px solid #E2E5E9;border-radius:6px;">
            ...
            <div style="display:flex;gap:10px;margin-top:18px;">
                <a href="korea-4-drilldown.html" style="text-decoration:none;">
                    <button
