...
//             Route::get('/manager/dashboard', [Contact90Controller::class, 'managerDashboard'])->name('manager.dashboard');
//             Route::get('/manager/fo-list', [Contact90Controller::class, 'managerFoList'])->name('manager.folist');
//             Route::get('/manager/fo/{user}', [Contact90Controller::class, 'managerFoDetail'])->name('manager.fodetail');
//             Route::post('/manager/validate/{contact90}', [Contact90Controller::class, 'validate'])->name('validate');
//             Route::post('/manager/validate-bulk', [Contact90Controller::class, 'validateBulk'])->name('validate.bulk');
//         });
//     });
