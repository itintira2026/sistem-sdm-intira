...
<head>
    ...
    <title>Kadiv — Drill-down Goal</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div style="padding:28px 32px;max-width:1000px;margin:0 auto;">
        ...
        <a href="kadiv-2-list-goal" style="text-decoration:none;">
            <button
        ...
        <div style="background:#E4EEEA;padding:14px 16px;border-radius:9px;margin-bottom:14px;">
            <h3 style="margin:0 0 4px 0;font-size:15px;color:#123328;">Rekrut Anggota Baru (porsi Marketing)</h3>
            <div style="font-size:12.5px;color:#6B7280;">70/hari · dari Direktur Bisnis</div>
            <div style="display:flex;align-items:center;gap:8px;margin-top:10px;">
                ...
                <span style="font-size:12px;font-weight:700;color:#C98A3D;width:36px;text-align:right;">82%</span>
            </div>
        </div>

        <a href="kadiv-3-form-breakdown" style="text-decoration:none;">
            <button
        ...
        <div style="background:#fff;border-radius:10px;padding:8px;box-shadow:0 1px 2px rgba(0,0,0,0.05);">
            ...
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    <span style="font-weight:600;">Staff — Dewi Anggraini</span><span
                        style="font-size:11px;color:#6B7280;font-weight:400;">Staff · 35/hari</span>
                </div>
            ...
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    ...
                    <span style="font-size:11px;color:#6B7280;font-weight:400;">Diri Sendiri</span>
                    <span
