...
<x-app-layout>
    ...
    <div class="py-6 sm:py-10">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            $hour = $jamCI->hour;
            $late = false;
            if ($hour >= 8 && $hour < 12) { $late=$jamCI->gt(\Carbon\Carbon::parse($tanggal . ' 08:00:00'));
                } elseif ($hour > 13 && $hour <= 21) { $late=$jamCI->gt(\Carbon\Carbon::parse($tanggal . ' 13:00:00'));
                    }
                    if ($late) {
                    ...
                    <div class="bg-white rounded-lg shadow-sm border-l-4 {{ $borderColor }} overflow-hidden">
                        ...
                        <button type="button" onclick="toggleAccordion('acc-{{ $loop->index }}')"
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span
                                    class="hidden sm:inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs bg-gray-100 text-gray-600">
                                ...
                                @php
                                $durasi =
                                \Carbon\Carbon::parse($checkIn->jam)->diffInMinutes(\Carbon\Carbon::parse($checkOut->jam));
                                    ...
                                    <div class="flex-1">
                                        <div class="relative">
                                            ...
                                            <div class="space-y-4">
                                                @php
                                                $statusList = [
                                                ['label' => 'Check In', 'item' => $checkIn, 'dot' => 'bg-green-500',
                                                'time_class' => 'text-green-700'],
                                                ['label' => 'Istirahat In', 'item' => $istirahatIn, 'dot' =>
                                                'bg-yellow-500', 'time_class' => 'text-yellow-700'],
                                                ['label' => 'Istirahat Out', 'item' => $istirahatOut, 'dot' =>
                                                'bg-blue-500', 'time_class' => 'text-blue-700'],
                                                ['label' => 'Check Out', 'item' => $checkOut, 'dot' => 'bg-red-500',
                                    ...
                                    {{ $s['item'] ? $s['dot'] : 'bg-gray-200' }}">
                                                    ...
                                                    <div class="flex-1 pb-1">
                                                        ...
                                                        <div
                                                            ...
                                                            <span class="italic text-gray-400">{{ $s['item']->keterangan
                                                                }}</span>
                                                            @endif
                                                        </div>
                                                        @endif
                                    ...
                                    <div class="border-t border-gray-100 pt-4">
                                        ...
                                        <div class="flex flex-row flex-wrap gap-3">
                                            ...
                                            <div class="group relative">
                                                ...
                                                <p class="text-center text-xs text-purple-400 mt-1 leading-tight">Outfit
                                                </p>
                                            </div>
                                            @endif
    ...
    {{-- Modal Foto --}}
    <div id="photoModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-80 p-4"
        onclick="if(event.target===this) closePhoto()">
        <div class="relative max-w-sm w-full bg-white rounded-xl overflow-hidden shadow-2xl"
