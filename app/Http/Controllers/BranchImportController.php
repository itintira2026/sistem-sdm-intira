...
class BranchImportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Import data
            // Excel::import($import, $file); // Gunakan variable $file
    ...
    //         // TAMBAHKAN BARIS INI - Dapatkan path string dari file
    ...
    //             'path_used' => $filePath,  // TAMBAHKAN INI
    //             'size' => $file->getSize(),
    //             'mime' => $file->getMimeType(),
    //         ]);
    ...
    //         // UBAH BARIS INI - Gunakan $filePath (string) bukan $file (object)
