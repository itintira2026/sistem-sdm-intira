    ...
    <div class="py-6 sm:py-10">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @php
                ...
                // Tentukan warna hari berdasarkan kondisi
            ...
            <div class="bg-white rounded-lg shadow-sm border-l-4 {{ $borderColor }} overflow-hidden">
                ...
                <div class="flex items-center justify-between px-5 py-3 bg-gray-50 border-b border-gray-100">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs bg-gray-100 text-gray-600">
                ...
                <div class="p-5">
                    <div class="flex flex-col md:flex-row gap-5">
                        ...
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <div class="space-y-4">
                                    ...
                                    @php
                                        $statusList = [
                                            ['key' => 'CHECK_IN',      'label' => 'Check In',      'item' => $checkIn,      'dot' => 'bg-green-500',  'time_class' => 'text-green-700'],
                                            ['key' => 'ISTIRAHAT_IN',  'label' => 'Istirahat In',  'item' => $istirahatIn,  'dot' => 'bg-yellow-500', 'time_class' => 'text-yellow-700'],
                                            ['key' => 'ISTIRAHAT_OUT', 'label' => 'Istirahat Out', 'item' => $istirahatOut, 'dot' => 'bg-blue-500',   'time_class' => 'text-blue-700'],
                                            ['key' => 'CHECK_OUT',     'label' => 'Check Out',     'item' => $checkOut,     'dot' => 'bg-red-500',    'time_class' => 'text-red-700'],
                                        ];
                                    @endphp
                        ...
                        <div class="flex flex-row md:flex-col gap-2 overflow-x-auto md:overflow-visible">
                            ...
                            <div class="flex-shrink-0 group relative">
                                <div class="relative overflow-hidden rounded-lg cursor-pointer"
                                    ...
                                    <img src="{{ Storage::url($entry->photo) }}"
                                        alt="{{ $entry->status }}"
                                        class="w-20 h-20 md:w-24 md:h-24 object-cover rounded-lg border-2 border-gray-200 group-hover:border-teal-400 transition-all"
                                        onerror="this.closest('.relative').innerHTML='<div class=\'w-20 h-20 md:w-24 md:h-24 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center\'><svg class=\'w-6 h-6 text-gray-300\' fill=\'none\' stroke=\'currentColor\' viewBox=\'0 0 24 24\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2\' d=\'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z\'/></svg></div>'">
    ...
    <div id="photoModal"
        ...
        <div class="relative max-w-sm w-full bg-white rounded-xl overflow-hidden shadow-2xl" onclick="event.stopPropagation()">
            <div class="flex items-center justify-between px-4 py-3 bg-gray-50 border-b border-gray-200">
                ...
                <button onclick="closePhoto()" class="p-1.5 rounded-lg text-gray-400 hover:bg-gray-200 hover:text-gray-600 transition">
