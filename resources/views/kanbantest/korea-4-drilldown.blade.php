...
<head>
    ...
    <title>Korea — Drill-down Goal</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div style="padding:28px 32px;max-width:1000px;margin:0 auto;">
        ...
        <div style="display:flex;gap:4px;margin:14px 0 20px 0;border-bottom:1px solid #E2E5E9;">
            <a href="korea-1-board" style="text-decoration:none;padding:9px 14px;font-size:13px;color:#6B7280;">Personal
                Board</a>
        ...
        <a href="korea-2-list-goal.html" style="text-decoration:none;">
            <button
        ...
        <div style="background:#E4EEEA;padding:14px 16px;border-radius:9px;margin-bottom:14px;">
            <h3 style="margin:0 0 4px 0;font-size:15px;color:#123328;">Rekrut Anggota Baru (porsi Area Jaksel)</h3>
            <div style="font-size:12.5px;color:#6B7280;">30/hari · dari Kadiv Marketing</div>
            <div style="display:flex;align-items:center;gap:8px;margin-top:10px;">
                ...
                <span style="font-size:12px;font-weight:700;color:#C98A3D;width:36px;text-align:right;">70%</span>
            </div>
        </div>

        <a href="korea-3-form-breakdown.html" style="text-decoration:none;">
            <button
        ...
        <div style="background:#fff;border-radius:10px;padding:8px;box-shadow:0 1px 2px rgba(0,0,0,0.05);">
            ...
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    ...
                    <span style="font-weight:600;">AM — Kemang</span><span
                        style="font-size:11px;color:#6B7280;font-weight:400;">15/hari</span>
                </div>
            ...
            <div style="margin-left:26px;border-left:1.5px dashed #E2E5E9;padding-left:14px;">
                <div
                    style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;"><span
                            style="font-weight:600;">Andi Nugraha</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">FO</span></div>
                    <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">4/5 (80%)</div>
                </div>
                <div
                    style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;"><span
                            style="font-weight:600;">Melati Putri</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">FO</span></div>
                ...
                <div
                    style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;"><span
                            style="font-weight:600;">Yusuf Hakim</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">FO</span></div>
                    <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">4/5 (80%)</div>
                </div>
            </div>
            ...
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    <span style="color:#6B7280;width:14px;display:inline-block;">&#9662;</span>
                    <span style="font-weight:600;">AM — Blok M</span><span
                        style="font-size:11px;color:#6B7280;font-weight:400;">15/hari</span>
                </div>
                <div style="font-size:12px;color:#C6493C;font-weight:700;width:130px;text-align:right;">53% ⚠</div>
            </div>
            <div style="margin-left:26px;border-left:1.5px dashed #E2E5E9;padding-left:14px;">
                <div
                    style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;"><span
                            style="font-weight:600;">Rangga Saputra</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">FO</span></div>
                    <div style="font-size:12px;color:#C6493C;font-weight:700;width:130px;text-align:right;">2/5 (40%)
                    </div>
                </div>
                <div
                    style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;"><span
                            style="font-weight:600;">Ika Lestari</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">FO</span></div>
