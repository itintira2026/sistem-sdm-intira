                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">Rp {{ number_format($totalGajiPokok, 0,
                                    ',', '.') }}</dd>
                            </dl>
                        </div>
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    Tidak ada data gaji pokok untuk periode <strong>{{
                                        Carbon\Carbon::create()->month($bulan)->format('F') }} {{ $tahun }}</strong> di
                                    cabang ini.
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="border-b border-gray-200">
                                    ...
                                    <th class="text-left py-4 px-4 text-sm font-semibold text-gray-600 uppercase">Email
                                    </th>
                                    <th class="text-left py-4 px-4 text-sm font-semibold text-gray-600 uppercase">Role
                                    </th>
                                    <th class="text-left py-4 px-4 text-sm font-semibold text-gray-600 uppercase">
                                        Periode</th>
                                    <th class="text-left py-4 px-4 text-sm font-semibold text-gray-600 uppercase">Gaji
                                        Pokok</th>
                                    <th class="text-left py-4 px-4 text-sm font-semibold text-gray-600 uppercase">
                                        Keterangan</th>
                                ...
                                <tr>
                                    <td colspan="7" class="py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-400 text-sm mt-1">Belum ada data gaji pokok untuk
                                                periode ini</p>
                                        </div>
                                    </td>
                                </tr>
