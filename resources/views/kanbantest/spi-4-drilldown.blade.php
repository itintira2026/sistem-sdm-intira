...
<head>
    ...
    <title>SPI — Drill-down Goal</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div style="padding:28px 32px;max-width:1000px;margin:0 auto;">
        ...
        <div style="background:#E4EEEA;padding:14px 16px;border-radius:9px;margin-bottom:14px;">
            <h3 style="margin:0 0 4px 0;font-size:15px;color:#123328;">Audit Kepatuhan Cabang</h3>
            <div style="font-size:12.5px;color:#6B7280;">Tipe Task · 12 cabang</div>
            <div style="display:flex;align-items:center;gap:8px;margin-top:10px;">
                ...
                <span style="font-size:12px;font-weight:700;color:#C6493C;width:36px;text-align:right;">41%</span>
            </div>
        </div>
        ...
        <p style="font-size:12px;color:#9AA1A9;margin-bottom:12px;">
            Catatan: kedalaman pohon tidak seragam — SPI→Staff cuma 2 level, SPI→Kadiv→dst bisa 3+ level.
        </p>

        <div style="background:#fff;border-radius:10px;padding:8px;box-shadow:0 1px 2px rgba(0,0,0,0.05);">

            <!-- Cabang pendek: SPI -> Staff langsung (2 level) -->
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    <span style="font-weight:600;">Audit dokumen cabang Jaksel</span>
                    <span style="font-size:11px;color:#6B7280;font-weight:400;">Staff — Dewi Anggraini</span>
                    <span
                ...
                <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">Selesai 8/12</div>
            </div>

            <!-- Cabang panjang: SPI -> Kadiv -> Korea -> AM -> FO (3+ level) -->
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    ...
                    <span style="font-weight:600;">Kadiv Operasional</span>
                    <span style="font-size:11px;color:#6B7280;font-weight:400;">Koordinasi audit wilayah timur</span>
                </div>
                <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">35%</div>
            </div>
            <div style="margin-left:26px;border-left:1.5px dashed #E2E5E9;padding-left:14px;">
                <div
                    ...
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                        <span style="color:#6B7280;width:14px;display:inline-block;">&#9662;</span>
                        <span style="font-weight:600;">Korea Area Timur</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">Korea</span>
                    </div>
                    <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">35%</div>
                </div>
                <div style="margin-left:26px;border-left:1.5px dashed #E2E5E9;padding-left:14px;">
                    <div
                        style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                        <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                            <span style="font-weight:600;">AM Cabang Timur 1</span><span
                                style="font-size:11px;color:#6B7280;font-weight:400;">AM</span>
                        </div>
                        <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">3/12 cabang</div>
                    </div>
                </div>
            </div>
