...
<head>
    ...
    <title>Direktur — Drill-down Goal</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div style="padding:28px 32px;max-width:1000px;margin:0 auto;">
        ...
        <div style="background:#E4EEEA;padding:14px 16px;border-radius:9px;margin-bottom:14px;">
            <h3 style="margin:0 0 4px 0;font-size:15px;color:#123328;">Pertumbuhan Anggota Q3 (porsi Bisnis)</h3>
            <div style="font-size:12.5px;color:#6B7280;">120/hari · dari Ketua</div>
            <div style="display:flex;align-items:center;gap:8px;margin-top:10px;">
                ...
                <span style="font-size:12px;font-weight:700;color:#C98A3D;width:36px;text-align:right;">75%</span>
            </div>
        </div>
        ...
        <div style="background:#fff;border-radius:10px;padding:8px;box-shadow:0 1px 2px rgba(0,0,0,0.05);">
            ...
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    ...
                    <span style="font-weight:600;">Kadiv Marketing</span>
                    <span style="font-size:11px;color:#6B7280;font-weight:400;">70/hari</span>
                </div>
            ...
            <div style="margin-left:26px;border-left:1.5px dashed #E2E5E9;padding-left:14px;">
                <div
                    style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                        <span style="font-weight:600;">Staff — Dewi Anggraini</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">Staff</span>
                    </div>
                    <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">35/35 (100%)</div>
                </div>
                <div
                    style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;">
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                        <span style="font-weight:600;">Staff — Fajar Ramadhan</span><span
                            style="font-size:11px;color:#6B7280;font-weight:400;">Staff</span>
                    </div>
                    <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">33/35 (94%)</div>
                </div>
                <!-- Node taktis turunan kadiv -->
                <div
                    ...
                    <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                        <span style="font-weight:600;">Sebar Brosur Promosi — 100 lembar/hari per FO</span>
                        <span style="font-size:11px;color:#6B7280;font-weight:400;">Diri Sendiri (Kadiv)</span>
                        <span
            ...
            <div
                ...
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    <span style="color:#6B7280;width:14px;display:inline-block;">&#9662;</span>
                    <span style="font-weight:600;">Kadiv Penjualan</span>
                    <span style="font-size:11px;color:#6B7280;font-weight:400;">50/hari</span>
                </div>
                <div style="font-size:12px;color:#6B7280;width:130px;text-align:right;">68%</div>
            </div>

            <!-- Node taktis milik Direktur sendiri -->
            <div
                style="padding:10px 12px;border-radius:7px;display:flex;justify-content:space-between;align-items:center;gap:12px;background:#FBEAE3;">
                <div style="display:flex;align-items:center;gap:8px;font-size:13px;">
                    <span style="font-weight:600;">Follow up 5 partner strategis/minggu</span>
                    <span style="font-size:11px;color:#6B7280;font-weight:400;">Diri Sendiri (Direktur Bisnis)</span>
                    <span
                        style="display:inline-block;padding:2px 8px;border-radius:12px;font-size:11px;font-weight:600;background:#fff;color:#B5502F;">Taktis</span>
                </div>
